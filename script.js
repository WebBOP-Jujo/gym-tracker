document.addEventListener('DOMContentLoaded', () => {
    ...
    function handleToggleManageSection() { /* ... (sin cambios) ... */ if(!exerciseManagementSection||!toggleManageBtn)return; const isVisible=exerciseManagementSection.style.display==='block'; if(isVisible){exerciseManagementSection.style.display='none'; toggleManageBtn.innerHTML='<i class="fas fa-list-ul"></i> Gestionar Lista de Ejercicios'; toggleManageBtn.classList.remove('active');} else{exerciseManagementSection.style.display='block'; toggleManageBtn.innerHTML='<i class="fas fa-eye-slash"></i> Ocultar Gestión'; toggleManageBtn.classList.add('active'); exerciseManagementSection.scrollIntoView({behavior:'smooth',block:'start'});} }
    ...
    function setLoading(isLoading, message='Guardando...') { /* ... (sin cambios) ... */ const saveHTML='<i class="fas fa-save"></i> Guardar Entrenamiento'; const loadHTML=`<i class="fas fa-spinner fa-spin"></i> ${message}`; if(!submitButton)return; submitButton.disabled=isLoading; submitButton.innerHTML=isLoading?loadHTML:saveHTML; }

    // --- Inicialización ---
    function initializeApp() { /* ... (sin cambios) ... */ console.log("Inicializando..."); if(exerciseManagementSection)exerciseManagementSection.style.display='none'; if(submitButton){submitButton.innerHTML='<i class="fas fa-save"></i> Guardar Entrenamiento'; submitButton.disabled=false;} addAddSetButton(); loadInitialHistory(); }
    initializeApp();
